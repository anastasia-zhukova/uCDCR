...
NEWSWCL50_FOLDER_NAME = "2025_annot"
ECBPLUS_REAN_FOLDER_NAME = "2025_annot"
...
ECBPLUS_METAM = "ECBplusMETAm-prep"
ECBPLUS_R = "ECBplus_r-prep"

# FILES
SAMPLE_DOC_JSON = "_sample_doc.json"
SAMPLE_MENTION_JSON = "_sample_mention.json"
MENTIONS_ALL_CSV = "all_mentions.csv"
MENTIONS_ALL_PARQUET = "all_mentions.parquet"
DOCUMENTS_ALL_CSV = "all_documents.csv"
DOCUMENTS_ALL_PARQUET = "all_documents.parquet"
...
MENTION_HEAD_ID_CONTEXT = "mention_head_id_context"
DOC = "doc"
DOC_ID = "doc_id"
...
CONTEXT_START_END_GLOBAL_ID = "context_start_end_global_id"
MENTION_SENTENCE_CONTEXT_START_END_ID = "mention_sentence_start_end"
...
LANGUAGE = "language"
SPLIT = "split"
TOKEN_ID_GLOBAL = "token_id_global"
CHAR_ID_START = "char_id_start"
...
DIRECTORIES_TO_SUMMARIZE = {
       ...
       HYPERCOREF: os.path.join(os.getcwd(), HYPERCOREF, OUTPUT_FOLDER_NAME),
        ...
        ECBPLUS_R: os.path.join(os.getcwd(), ECBPLUS_R, OUTPUT_FOLDER_NAME),
}

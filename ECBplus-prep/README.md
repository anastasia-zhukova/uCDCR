...
Two versions of the dataset can be created: 
1) original all annotated mentions and clusters (saved into ```\output_data_unvalidated```)
2) (default) mentions from the manually validated sentences as described in [Cybulska and Vossen (2015)](https://aclanthology.org/W15-0801/)
